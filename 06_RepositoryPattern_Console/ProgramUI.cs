...
namespace _06_RepositoryPattern_Console
{
    class ProgramUI
    {
        ...
        public void Run()                                               //Method 'Run' is our entry to the UI code.  made 'public' because we need someone to make an instance of our programUI and call this method.  Void meaning it does not need a return type.
        {
            SeedContentList();                                          //Our setup goes here.  Anything that we need to do before the User sees it. 
            Menu();
        }

        //Menu                                                          //Menu is typically the first thing a user sees.
        private void Menu()                                             //almost everything else in this class will be made 'private'  This being so that the only way into the programUI will be through the Run method
        {
        ...
        private void CreateNewContent()
        {
            ...
            //IsFamilyFriendly
            Console.WriteLine("Is this content famly friendly (y/n)");
        ...
        private void UpdateExistingContent()
        {
         ...
         //We will build a new object
            ...
            if (wasUpdated)
            {
                Console.WriteLine("Contennt was successfully updated!");
            }
            else
            {
